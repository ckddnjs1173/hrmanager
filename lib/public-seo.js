import { transformUserFacingHtml } from "./user-facing-page.js";
...
export function createArticlePageHandler(rootDir, { env = process.env } = {}) {
  ...
  return (req, res, next) => {
    ...
    fs.readFile(filePath, "utf8", (error, html) => {
      ...
      res.send(transformUserFacingHtml(rewritePublicDocumentMetadata(html, { siteOrigin: origin, pathname: req.path }), {globalNavigation:true}));
    });
  };
}

...
const BAD_REQUEST_PREFIXES = [
  "business_case_title_", "business_case_summary_", "business_case_transition_",
...
const NOT_FOUND_CODES = new Set([
  "business_case_not_found", "business_case_organization_not_active", "external_advisor_grant_not_found",
  "external_advisor_resource_not_found", "external_advisor_organization_not_active", "external_advisor_management_membership_required",
  "external_advisor_cross_tenant_case_forbidden", "external_advisor_cross_tenant_resource_forbidden",
  "external_advisor_shared_case_not_found", "external_advisor_invitation_not_found",
]);

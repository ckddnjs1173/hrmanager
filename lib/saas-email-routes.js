...
function errorStatus(error) {
  ...
  if (["invalid_email", "invitation_role_invalid", "invitation_invalid", "external_advisor_invitation_not_found", "external_advisor_permission_invalid", "external_advisor_permissions_required"].includes(code)) return 400;

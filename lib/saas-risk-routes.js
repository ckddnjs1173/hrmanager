...
const errorStatus = createErrorStatusResolver([
  { codes: ["compliance_scope_not_found", "compliance_action_not_found", "notification_not_found"], status: 404 },
  { codes: ["permission_denied", "csrf_invalid"], status: 403 },
  { prefixes: ["compliance_action_", "risk_", "calendar_", "notification_"], status: 400 },
]);

...
import { createSaasBusinessCaseDocumentRouter } from "./saas-business-case-document-routes.js";
...
export function createApplication({ rootDir, env = process.env, warn = console.warn } = {}) {
  ...
  app.use("/api/saas", createSaasBusinessCaseDocumentRouter({ env, rateLimit }));

...
export function validateOfficialSource({ sourceType, canonicalSourceId = null, authority, title, officialUrl } = {}) {
  ...
  let parsed = null;
  try { parsed = new URL(String(officialUrl || "")); } catch {}
  if (!parsed || parsed.protocol !== "https:" || !OFFICIAL_HOSTS.includes(parsed.hostname.toLowerCase())) errors.push("legal_source_official_url_invalid");

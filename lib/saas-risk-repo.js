...
import { refreshBusinessOnboardingState } from "./saas-business-repo.js";
...
export async function runBusinessRiskScan({ organizationId, actorUserId, complianceScopeId = null, triggerType = "MANUAL", requestId = null } = {}) {
  ...
  const onboarding = await refreshBusinessOnboardingState(organizationId, { actorUserId, eventType: "RISK_SCAN_COMPLETED" });
